...
static const char _LEFT_ARROW[]     PROGMEM = "\x05""";
static const char _RIGHT_ARROW[]    PROGMEM = "\x06""";
static const char _PAGE_FWD[]       PROGMEM = "PAGE \x06""";
static const char _PAGE_BCK[]       PROGMEM = "\x05"" PAGE";
static const char _PG_FWD[]         PROGMEM = "PG\x06""";
static const char _PG_BCK[]         PROGMEM = "\x05""PG";
...
static const char _INPUT[]          PROGMEM = "CHIP INPUT";
...
static const char _INP[]            PROGMEM = "INP";
...
const char *const STRINGS[STRING_COUNT] PROGMEM = {
    ...
    _LONG_PRESS, _CONFIRM, _INSUFF, _ONE_OR_MORE, _UNAVAIL,
    _PLEASE_WAIT, _REMAINING, _INVENTORY, _SETTINGS, _STATUS,
...
const struct Row ROW_TABLE[SCREEN_COUNT * 3] PROGMEM = {
    ...
    { S_VERSION, 1, WRITE_1(6)  },
    // INPUT (7):
    { S_INPUT, 5, WRITE_NONE },
    { 0xFF, 0, WRITE_NONE },
    { 0xFF, 0, WRITE_NONE },
    // SETTINGS/LOCALE (8):
    { S_LOCALE, 7, WRITE_NONE },
    { S_CURRENCY, 1, WRITE_1(11) },
    { S_LANGUAGE, 1, WRITE_1(11) },
    ...
    // WAIT (15):
    { 0xFF, 0, WRITE_NONE },
    { S_PLEASE_WAIT, 3, WRITE_NONE },
    { 0xFF, 0, WRITE_NONE },
};

const struct Button BTN_TABLE[SCREEN_COUNT * 4] PROGMEM = {
    // MENU/HOME (0):
    BUTTON_(S_OUT, 0, 5),
    BUTTON_(S_INV, 5, 5),
    BUTTON_(S_SET, 10, 5),
    ...
    // OUT/DISPENSE (1):
    BUTTON_(S_PLACEHOLDER, 0, 5),
    BUTTON_(S_PLACEHOLDER, 5, 5),
    BUTTON_(S_PLACEHOLDER, 10, 5),
    BUTTON_(S_PLACEHOLDER, 15, 5),
    // OUT/DISPENSE REVIEW (2):
    BUTTON_(S_NO, 0, 5),
    BUTTON_(S_MENU, 5, 10),
    BUTTON_(S_YES, 15, 5),
