...
namespace StackLabs {
    namespace Locale {
        static const char* const STRINGS[STRING_COUNT] PROGMEM = {
            ...
            _VERSION, _LCD_SET, _BACKLIGHT, _SLEEP, _LOCALE, _CURRENCY,
            _LANGUAGE, _DEVINFO, _HARDWARE, _FIRMWARE, _SOFTWARE, _PLATFORM,
            _FREEMEM, _UPTIME, _ERRS, _VALUES, _A, _B, _SYSTEM_OFF, _GOODBYE,
            _SHUTTING_DOWN, _LCD, _LOC, _VAL
        };

        static const Row ROW_TABLE[SCREEN_COUNT * 3] PROGMEM = {
            // MENU/HOME (0):
        ...
        static const Button BTN_TABLE[SCREEN_COUNT * 4] PROGMEM = {
            // MENU/HOME (0):
            BUTTON_(S_OUT, 0, 5),
            BUTTON_(S_INV, 5, 5),
            BUTTON_(S_SET, 10, 5),
